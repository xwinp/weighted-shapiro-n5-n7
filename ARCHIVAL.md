...
**Rev 12 (current `HEAD`)** supersedes rev 11. **No theorem statement or numerical invariant changed** — collar `gmin=7.344054>L_C`, exhaustiveness `components=2 cells=6 fibers=5 edges=2823`, Arb `2604/2604`, `min 7.050005>141/20` are all identical to rev 4–11. Rev 12 **closes three proof-gap must-fixes** identified in GPT's pre-submission audit (rigorizing existing claims, not altering results), plus GPT's three recommended prose fixes:
